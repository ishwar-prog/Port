...
const experiences = [
  {
    ...
    description: 'Working on full-stack development projects, building scalable web applications using modern technologies like React, Node.js, and MongoDB.',
  ...
  },
  {
    ...
    description: 'Developed machine learning models for financial data analysis and prediction. Worked on data preprocessing, model training, and deployment.',
...
const Experience = () => {
  ...
  return (
    <section id="experience" className="min-h-screen py-32 px-6 md:px-16 lg:px-32 relative">
      {/* Background */}
